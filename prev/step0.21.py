"""
=================================================================
📚 STEP 0.2: Qwen vs Mistral 비교 - 플러그인 버전 (섹션별 실행)
=================================================================

⚠️ 실행 전 준비:
1. summary_evaluator_plugin.py를 Colab에 업로드!
2. 왼쪽 파일 탭 → 업로드 버튼
...
if INSTALL_FLAG.exists():
    ...
    print()
    print("재시작 후:")
    print("1. summary_evaluator_plugin.py 업로드 ⚠️")
    print("2. 섹션 2부터 실행하세요!")
    print("="*60)
...
# JSON
json_file = RESULTS_DIR / f"plugin_results_{timestamp}.json"
with open(json_file, 'w', encoding='utf-8') as f:
    json.dump(all_results, f, indent=2, ensure_ascii=False)
print(f"✅ JSON: {json_file}")

# CSV
csv_file = RESULTS_DIR / f"plugin_results_{timestamp}.csv"
